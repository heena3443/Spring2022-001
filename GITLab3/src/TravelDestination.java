...
public class TravelDestination {
	...
	public static void main(String[] args) {
        ...
        System.out.println("My name is Alex Rodriguez. I wish to travel to Quebec one day!"); 
				...
				System.out.println("My name is Justin Breaux. I wish to travel to South Korea one day!");
        System.out.println("My name is Alex Rodriguez. I wish to travel to Quebec one day!"); 
				System.out.println("My name is Roshan Vareed. I wish to travel to Quebec one day!");
        ...
        System.out.println("My name is Logan Hall. I wish to travel to New York one day!"); 
				...
				System.out.println("My name is Tyler Jobe. I wish to travel to Ireland ine day!");
				System.out.println("My name is Logan Ramirez, I wish to travel to Sweden one day!");
				System.out.println("My name is Ross Ferrer, I wish to travel to South Korea one day!");
				System.out.println("My name is Mario Alday, I wish to travel to Italy one day!");
				System.out.println("My name is Vatsal Patel, I wish to travel to Japan one day!");
